...
const Sidebar = () => {
  return (
    <div>
      ...
      <p>
          <a className='px-2 py-1 my-3 bg-gray-200 rounded-full flex items-center justify-center'download="hridoy's-resume" href=""><FcDownload className="w-6 h-6"></FcDownload> Download Resume</a>
      </p>
   ...
   <div className='flex justify-around w-9/12 my-5 md:w-full mx-auto'>
      ...
      <button className='bg-gradient-to-r from-green to-blue-400 w-8/12 py-2 rounded-full px-5 text-white my-2'>Togle ui</button>
    </div>
  )
}
